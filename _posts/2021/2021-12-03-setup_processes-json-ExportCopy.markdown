---
layout: article
title: ExportCopy_v090.json
categories: setup_processes
excerpt:   Install processes for exporting copies of data layers
tags:: 
    - json/ExportCopy
date: 2021-12-03
modified: 2021-12-03
...
# json/ExportCopy (setup_processes)

###   Install processes for exporting copies of data layers

The json command file <span class='file'>ExportCopy_v090.json</span> is part of karttur's GeoImagine project <span class='project'>setup_processes</span>. Calling the json file will execute the following commands of the GeoImagine Framework.
